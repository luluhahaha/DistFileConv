...
with open('C:/Users/ainaolaji/Documents/two_feeders/DistFileConv/OpenDSS/Feeder_7773/Lines.dss') as f:
    lines = f.readlines()

# print(type(lines))
# print(lines)

with open('C:/Users/ainaolaji/Documents/two_feeders/DistFileConv/OpenDSS/Feeder_7773/Transformers.dss') as f:
    trafo = f.readlines()
...
color_map = ['red' if node == 'SOURCE_7773' else 'green' for node in g]
size_map = [50 if node == 'SOURCE_7773' else 10 for node in g]
...
#
# wb.save('Node_connections_7773.xls')

## Writing to an CSV file using Python
import csv

with open('Node_connections_7773.csv', mode='w', newline= '') as file:
